      ...
      Object.keys(routes).forEach((m2) => {
        if (method === METHOD_NAME_ALL || method === m2) {
          Object.keys(routes[m2]).forEach(
            (p) => re2.test(p) && routes[m2][p].push([handler, paramCount])
          );
        }
      });
      return;
...
var nt = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" };
var de = /* @__PURE__ */ __name((l3) => nt[l3], "de");
function O(l3, e) {
  if (e) {
...
<body>
  ...
  <footer>
    <p>&copy; ${(/* @__PURE__ */ new Date()).getFullYear()} Azlan Ali Khan. All rights reserved.</p>
  </footer>
</body>
</html>`;
}
__name(shell, "shell");
function notesHtml(tag) {
...
__name(notesHtml, "notesHtml");
function noteShell(title, content, slug) {
...
app.get("/note/:slug", async (c) => {
  ...
  const content = await g(text);
  const title = slug.replace(/-/g, " ").replace(/\b\w/g, (l3) => l3.toUpperCase());
